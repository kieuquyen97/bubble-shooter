...
{
?>
	Bạn đã đăng nhập với username = <? echo($_SESSION['username'])?>. <br />
...
<table width="40%" border="0">
  <tr>
    ...
    <th width="83%" scope="col"><div align="left">
      <input name="txtName" type="text" value="<? echo($_COOKIE['ckName']) ?>" />
    </div></th>
  </tr>
  <tr>
    <th scope="row"><div align="left">Password:</div></th>
    <td><div align="left">
      <input name="txtPass" type="password" value="<? echo($_COOKIE['ckPass']) ?>" />
    </div></td>
  </tr>
  <tr>
